...
using Pilat.Eshop.Tests.Helpers;

namespace Pilat.Eshop.Tests
{
    public class FileUploadTests
    {
        ...
        public async Task UploadImageFile_Success()
        {
            ...
            //nastaven� fakeov� IFormFile pomoc� MemoryStream
            ...
            _testOutputHelper.WriteLine("vytvo�en� cesta path: " + path);
            _testOutputHelper.WriteLine("vytvo�en� cesta relativePath: " + relativePath);
            _testOutputHelper.WriteLine("vytvo�en� cesta ImageSrc: " + ImageSrc);
