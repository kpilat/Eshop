...
using Pilat.Eshop.Web.Models.ApplicationServices.Implementation;
...
namespace Pilat.Eshop.Web
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<EshopDbContext>(options => options.UseMySql(Configuration.GetConnectionString("MySqlConncetionString"), new MySqlServerVersion("8.0.26")));
